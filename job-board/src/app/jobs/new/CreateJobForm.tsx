...
import { CreateJob, createJobSchema } from "@/lib/validation";
    ...
    <main className="mx-auto my-10 max-w-3xl space-y-10">
      <div className="space-y-5 text-center">
        ...
        <p className="text-muted-foreground">
          Get your job posting seen by thousands of potential employers.
        </p>
      </div>
      <div className="space-y-6 rounded-lg border p-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Provide a job description and requirements.
          </p>
        </div>
        <Form {...form}>
          <form
